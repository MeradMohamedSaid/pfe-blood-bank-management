...
const AppNotice = () => {
  ...
  const handleAppointmentSetted = async () => {};
          ...
          docs === 1 ? (
            <>
              <div className="flex flex-col justify-center items-center min-h-[80vh] fade-in-up">
                ...
                <p>
                  Your application is currently being processed by our team at a
                  high pace.{" "}
                </p>
            ...
            <div className="max-w-[60%] mx-auto ">
              ...
              <h1 className="mt-6">
                {!center
                  ...
                  ? "Now , select a day :"
                  : !periodSelected
                  ? "Finally , select a period :"
                  : "You're all set! Now, just hit that big red button down there to finalize the process."}
              </h1>
              <div className="w-full flex items-center justify-between gap-2">
                {/* center */}
                <div
                  className="relative w-full bg-white p-4 rounded-xl flex justify-between items-center gap-2 w-full border border-red text-red cursor-pointer"
                  onClick={() => setShowCenterSelection(!showCenterSelection)}
                >
                ...
                <div
                  ...
                  onClick={
                    center ? () => setShowDaySelection(!showDaySelection) : null
                  }
                >
                ...
                <button
                  className={
                    periodSelected !== null || isWorking
                      ? "w-[60%] py-4 bg-red text-white text-center text-bolder rounded-xl hover:bg-opacity-60 duration-300"
                      : "w-[60%] py-4 bg-red bg-opacity-40 text-white text-center text-bolder rounded-xl cursor-not-allowed"
                  }
              ...
              {role === 2 ? (
                <p>
                  ...
                  ensures the smooth and efficient validation of your request.
                </p>
              ) : (
                <p>
                  Your cooperation in this matter is greatly appreciated and
